...
public class JsonTaskGetAsset extends AsyncTask<String, String, GetAsset> {

    public JsonTaskGetAsset() {
        super();
    }

    protected GetAsset doInBackground(String... params) {
        ...
        try {
            ...
            if(authOk){
                ...
                Type t = new TypeToken<GetAsset>(){}.getType();
    ...
    @Override
    protected void onPostExecute(GetAsset result) {
